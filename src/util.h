...
public:
	...
	static float getAngle(int x0,int y0,int x1,int y1,int m0,int n0,int m1,int n1);

	static void linearRegression(std::vector<cv::Vec4i>& points);

	static void fuseLineWithPluecker(cv::Vec4i& l1_ret,cv::Vec4i& l2);
